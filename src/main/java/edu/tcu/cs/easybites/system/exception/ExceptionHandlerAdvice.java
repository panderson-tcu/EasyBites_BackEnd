...
public class ExceptionHandlerAdvice {
    ...
    Result handleInsufficientAuthenticationException(InsufficientAuthenticationException ex) {
        return new Result(false, StatusCode.UNAUTHORIZED,"Login credentials are required.", ex.getMessage());
    }
    ...
    /**
     *  Fallback handles unhandled exceptions.
     * @param ex
     * @return
     */
    ...
    Result handleOtherException(Exception ex) {
        return new Result(false, StatusCode.INTERNAL_SERVER_ERROR,"Internal server error occurs.", ex.getMessage());
    }
}
